            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Welcome <?php echo $_SESSION['user_id']; ?></h3>
                  <h6 class="font-weight-normal mb-0">This is Vulneralbe Website! <span class="text-primary">Let's Find Vulnerabilities!</span></h6>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 grid-margin">
              <div class="card tale-bg">
                  ...
                  <img src="/images/dashboard/hack.png" alt="people">
                  <div class="weather-info">
                    <div class="d-flex">
                      <div class="ml-2">
                        <h4 class="location font-weight-bold text-light">Web Hacking</h4>
                      </div>
                ...
                <div class="col-md-12 mb-4 stretch-card transparent">
                  <div class="card card-inverse-primary">
                    <div class="card-body">
                      ...
                      <h5 class="fs-20 mb-2">Find any Vulnerabilities!!</h5>
                      <p class="fs-10" > 
                        There are a lot of vulnerabilities in this website.<br><br>
                        Its main goal is to be an aid for students to study web hacking 
                        skills and tools in a real world environment.<br><br>
                        there are vulnerabilities that
                        i intended to makes, but you might find other vulnerabilities that i didn't intended.<br><br>
                        Try to discover as many issues as possible!                        
                      </p>
                    </div>
                  </div>
                </div>  
